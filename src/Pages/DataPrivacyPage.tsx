  ...
  return (
    <>
      ...
      <p>
        ...
        <br /> [Name]
        <br /> [ladungsfähige Anschrift]
        <br /> [gesonderte E-Mail-Adresse des Datenschutzbeauftragten]
      </p>
      <p>
      ...
      <p>
        Bitte richten Sie Ihren Widerspruch [oder Widerruf] formlos an folgende
        Adresse:
      </p>
      <p>
      ...
      <p>
        ...
        weiter das Recht, sich bei einer Aufsichtsbehörde über die Verarbeitung
        zu beschweren. Eine Liste der entsprechenden Behörden finden Sie unter:
      ...
      <h2>Hosting</h2>
      <p>
        <br /> Unser Hoster erhebt in sog. Logfiles folgende Daten, die Ihr
        Browser übermittelt:
      </p>
      <p>
