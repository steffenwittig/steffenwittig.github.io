            ...
            },
            {
              ...
              answer: (
                <>
                  ...
                  <p>
                    This confused many of its 9 subscribers. Then the same thing happened on the steffenwittig.com
                    domain. The situation was complicated and a legal battle ensued that went on for years. Details are
                    not known but in the end a judge ordered both Steffen Wittigs to share the YouTube channel and
                    create a separate but at the same time combined portfolio page. Both parties consider this madness
              ...
              answer: (
                <>
                  <p>
                    ...
                    outsider art but little is known about their origins and whereabouts. First traces on the web lead
                    to a German comic anthology so we can assume they are German.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    This is supposed to make it harder for HR professionals that consider hiring the artist to find
                    their art online and be scared by its contents. In this theory NotSteffenWittig is a pseudonym that
                    still contains the whole real name (if it actually is their real name, which is still up for debate)
                    and effectively obfuscates nothing. Others say it is just NotSteffenWittig's brand of humor to
                    confuse people.
                  </p>
                </>
              ),
